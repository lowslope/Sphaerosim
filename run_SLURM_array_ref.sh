...
#SBATCH --export=NONE
#SBATCH --output=/work/xu077052/Projekte/sphaerosim/out/ref/output.%J.txt
...
mkdir ${SLURM_JOB_ID}
cd ${SLURM_JOB_ID}
echo "Array ID:${SLURM_ARRAY_TASK_ID}"ThreadSanitizer
...
export TEST_FLAGS_COMPILER="${OUT[2]}"

RunType="release"
export OUTPUT_DIR="/rwthfs/rz/cluster/hpcwork/xu07705a/Projekte/sphaerosim/out/ref"
...
make -j
date
${RunPrefix} ./Sphaerosim -f /work/xu077052/Projekte/sphaerosim/InputFile_Linux_ref.xml
date
####  Compiler and Flag Test${SLURM_ARRAY_TASK_ID}
