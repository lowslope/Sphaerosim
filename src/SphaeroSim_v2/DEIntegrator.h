...
private:
    ...
    static double IntegrateCore
        ...
        for (int level = 1; level != numLevels; ++level) {
            ...
            if (level == 1) {
                continue;
            } // previousDelta meaningless, so cannot check convergence.
            ...
            double r = log(currentDelta) /
                       log(previousDelta);  // previousDelta != 0 or would have been kicked out previously
