    ...
    private:
        ...
        void EnsureCapacity(int cap) {
            ...
            if (cap > _allocated) {
                ...
                memcpy(newMem, _mem, sizeof(T) * size_);    // warning: not using constructors, only works for PODs
                if (_mem != _pool) {
                    delete[] _mem;
                }
                _mem = newMem;
        ...
        int size_;            // number objects in use
    };
